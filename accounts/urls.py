...
user_patterns = [
    # Cache the dashboard view for 15 minutes
    path('dashboard/', cache_page(60*15)(DashboardView.as_view()), name='dashboard'),    path('profile/', UserProfileView.as_view(), name='user_profile'),
